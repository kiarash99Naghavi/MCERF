...
class VisionRAG:
    ...
    def answer_query(
        ...
        vision_part = [{"type": "text", "text": imgDiscription}] if imgDiscription else []
        messages = [
            {"role": "system", "content": [{"type": "text", "text": system_prompt}]},
            {"role": "user", "content": image_parts + vision_part + [{"type": "text", "text": user_question}]},
        ]
        # print(f"Query: {user_question})")
        # 4) Call OpenAI (GPT-5 nano)
