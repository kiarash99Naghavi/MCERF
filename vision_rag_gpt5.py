...
"""
VisionRAG: Retrieval-Augmented Generation over PDFs with GPT-5 Mini
"""
...
class VisionRAG:
    ...
    def answer_query(
        ...
        """
        Retrieve top-k pages and answer with GPT-5 Mini.
        """
        ...
        resp = client.chat.completions.create(
            model="gpt-5-mini",
            messages=messages,
            **({"reasoning_effort": reasoning} if reasoning is not None else {})
        )
