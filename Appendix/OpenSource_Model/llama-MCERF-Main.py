...
import vision_rag_llama
reload(vision_rag_llama)
from vision_rag_llama import VisionRAG
        ...
        for index, row in df.iterrows():
            ...
            try:
                ...
                answer = rag.answer_query(
                    ...
                    k=3, #Turn to 5 for Functional Performance
...
def main():
    ...
    """
    print("Setting up VisionRAG with Llama 3.2 11B Vision...")
    ...
    for subtask_name, config in SUBTASK_CONFIGS.items():
        # if subtask_name != "rule_Functional_performance_qa": # uncomment to run only functional performance
        #     continue  # For testing, only process one subtask
        try:
