...
FALLBACK_INPUT_PATH = "/home/mrv24001/Documents/MDocAgent/dataset/docs/FSAE_Rules_2024_V1.pdf"
OUTPUT_DIR = "results"
...
def process_subtask(subtask_name, config, rag):
    ...
    try:
        ...
        output_filename = f"{config['name']}_with_predictions_{REASONING}_reasoning_gpt5mini.csv"
...
def main():
    ...
    for subtask_name, config in SUBTASK_CONFIGS.items():
        if subtask_name != "rule_retrieval_qa":
             continue
        try:
